...
<input type="text" id="last_name" name="last name" placeholder="Martin" required>
</div>
<div>
<label for="prenom">Votre prénom</label>
<input type="prenom" id="first_name" name="first name" placeholder="Dupont" required>
</div>
<div>
...
<input type="date" id="dob" name="date of birth" placeholder="01/01/1990" required>
</div>
<div>
